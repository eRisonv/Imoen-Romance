...
//	+ ~Global("ImoenRomanceActive","GLOBAL",2) IsGabber(Player1) GlobalGT("IRTQTPocket1","GLOBAL",1) Global("IRTQTPocket2","GLOBAL",0) AreaCheck("AR4500") OR(2) Dead("Abazigal") Dead("Sendai")~ + ~(Провести немного времени с Имоен и расслабиться.)~ DO ~SetGlobal("IRTQTPocket2","GLOBAL",1) IncrementGlobal("IRTLoveMeter","GLOBAL",2)~ + 4QT
