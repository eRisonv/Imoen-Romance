...
/*
PID option:
+ ~GlobalGT("IRTLoveMeter","GLOBAL",7) Global("IRTMarriageTalk","GLOBAL",1) Gender(Player1,MALE)~ + ~Ты бы хотела когда-нибудь выйти замуж, Имоен?~ DO ~IncrementGlobal("IRTLoveMeter","GLOBAL",1) SetGlobal("IRTMarriageTalk","GLOBAL",2)~ GOTO Mar1
+ ~GlobalGT("IRTLoveMeter","GLOBAL",7) Global("IRTMarriageTalk","GLOBAL",1) Gender(Player1,FEMALE)~ + ~ Ты бы хотела когда-нибудь выйти замуж, Имоен?~ DO ~IncrementGlobal("IRTLoveMeter","GLOBAL",1) SetGlobal("IRTMarriageTalk","GLOBAL",2)~ GOTO MarF
+ ~!GlobalGT("IRTLoveMeter","GLOBAL",7) Global("IRTMarriageTalk","GLOBAL",1)~ + ~ Ты бы хотела когда-нибудь выйти замуж, Имоен?~ DO ~SetGlobal("IRTMarriageTalk","GLOBAL",2)~ GOTO MarTooLow
*/
